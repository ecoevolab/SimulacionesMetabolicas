...
path_list = glob.glob('01_data/rizo/carveme/ST00000*_lb.xml')
# ----------------------------
...
for model_path in path_list:
    ...
    model_id = file_name.replace('_lb.xml', '') 
...
summary_csv_path = os.path.join(csv_output_path, "reacciones_totales_reactions_ecoli_2.csv")
