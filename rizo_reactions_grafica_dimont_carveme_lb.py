...
file_path = os.path.join('04_resultados/rizo/biomasas', 'reacciones_totales_reactions_dimont_carveme_lb.csv')
...
output_path = os.path.join(output_folder, "reacciones_dimont_carveme_lb_lb.png")
