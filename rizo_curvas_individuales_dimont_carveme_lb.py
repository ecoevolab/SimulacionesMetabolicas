...
import numpy as np
# -----------------------------------
csv_files = glob.glob('./04_resultados/rizo/biomasas/*_dimont_carveme_lb.csv')
colores_bac = {
...
for file in csv_files:
    ...
    model_id = file_name.replace('_dimont_carveme_lb.csv', '')
    ...
    try:
        ...
        output_path = os.path.join(output_folder, f"{model_id}_dimont_carveme_lb.csv.png")
