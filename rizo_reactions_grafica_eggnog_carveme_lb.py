...
file_path = os.path.join('04_resultados/rizo/reacciones', 'reacciones_totales_eggnog_carveme.csv')
...
output_path = os.path.join(output_folder, "reacciones_eggnog_carveme_lb_lb.png")
