...
st60_example = [
    {
        ...
        "path_to_model": os.path.join("./02_data/rizo/carveme/ST00060_prokka_carveme_lb.xml"),
        "model_type": "carveme",
        "path_to_genome": genome_path
    },
    {
        "model_id": "st60_gapseq",
        "path_to_model": os.path.join("./02_data/rizo/gapseq/ST00060_prokka_gapseq_lb.xml"),
        "model_type": "gapseq", 
        "path_to_genome": genome_path
    }, 
     {
...
supermodel_60 = gathered.assemble_supermodel("./04_resultados/gemsembler_output/",
                                                path_final_genome_aa = "./02_data/rizo/anotacion/prokka/ST00060_prokka.faa")


supermodel_60_mix = gathered.assemble_supermodel("./04_resultados/gemsembler_output/",
                                                 path_final_genome_aa = ("./02_data/rizo/anotacion/prokka/ST00060_prokka.faa"), do_mix_conv_notconv=True)

supermodel_60.write_supermodel_to_json("./04_resultados/gemsembler_output/60_supermodel.json")

supermodel_60 = read_supermodel_from_json("./04_resultados/gemsembler_output/60_supermodel.json")
supermodel_60.at_least_in(2)
core2 = get_model_of_interest(supermodel_60, "core2")
core2 = get_model_of_interest(supermodel_60, "core2", "./04_resultados/gemsembler_output/60_core2.xml")
